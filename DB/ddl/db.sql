...
INSERT INTO `admins` (`uid`, `username`, `password`, `salt`, `email`, `role`, `status`) VALUES (1, 'admin', '1e95b0358f0465957bf236079d064a6c5be22a1c', '516f36ef1b','dili@cms.com', 1, 1);
...
DELETE FROM `backend_settings`;

INSERT INTO `backend_settings` (`backend_theme`, `backend_lang`, `backend_root_access`, `backend_access_point`, `backend_title`, `backend_logo`) VALUES ('default', 'zh-cn', 1, '', 'DiliCMS', 'images/logo.gif');




DROP TABLE IF EXISTS `cate_fields`;
CREATE TABLE IF NOT EXISTS `cate_fields` (
...
DELETE FROM `cate_fields`;



DROP TABLE IF EXISTS `cate_models`;
CREATE TABLE IF NOT EXISTS `cate_models` (
...
INSERT INTO `menus` (`menu_id`, `class_name`, `method_name`, `menu_name`, `menu_level`, `menu_parent`)
VALUES (1, 'system', 'home', '系统', 0, 0), (2, 'system', 'home', '后台首页', 1, 1)
, (3, 'system', 'home', '后台首页', 2, 2), (4, 'setting', 'site', '系统设置', 1, 1)
, (5, 'setting', 'site', '站点设置', 2, 4), (6, 'setting', 'backend', '后台设置', 2, 4)
, (7, 'system', 'password', '修改密码', 2, 4), (8, 'system', 'cache', '更新缓存', 2, 4)
, (9, 'model', 'view', '模型管理', 1, 1), (10, 'model', 'view', '内容模型管理', 2, 9)
, (11, 'category', 'view', '分类模型管理', 2, 9), (12, 'plugin', 'view', '插件管理', 1, 1)
...
, (21, 'mp3/mp3', 'home', 'mp3管理', 1, 1)
, (22, 'mp3/mp3', 'home', '内容管理', 2, 21);
...
INSERT INTO `roles` (`id`, `name`, `rights`, `models`, `category_models`, `plugins`) VALUES (1, 'root', '', '', '', '');
...
INSERT INTO `validations` (`k`, `v`) VALUES ('required', '必填'), ('valid_email', 'E-mail格式');