define('weiboyi', function(require) {
            ...
            loadData: function(filters, order) {
                ...
                if (this.url) {
                    ...
                    this.request.done(function(json) {
                        ...
                        var data = (self.dataFilter || defaultDataFilter)(json);
            ...
            renderCell: function (cell, text, row, col, self) {
                if (col.formatter) {
                    ...
                    if (col.tmplPreprocessor) {
                        data = col.tmplPreprocessor(row, col, self);
                    }
    ...
    (function($, W, undefined) {
        ...
        W.form = {
             ...
             * @param  {[type]} forceSimulate   强制使用模拟的placeholder(chromev38以前不支持placeholder换行)
             * @return {[type]}             [description]
             */
            holdPlace: function(el, placeholder, forceSimulate) {
                ...
                function simulate(input, text) {
                    ...
                    holder.html(W.util.encodeHtmlChar(text).replace(/\n/g, '<br/>'));
                    ...
                    if (input.get(0).tagName.toLowerCase() !== "textarea") {
                        ...
                        css.lineHeight = input.css('lineHeight');
                    }
    ...
    (function($, W, undefined) {
        ...
        W.createComponent({
            ...
            methods: methods,
            extend: W.Container,
            api: ["setActiveTab", "getActiveTab", "hide", "show", "status", "render", "doLoader", "trigger", "removeListener", "addListener", "load", "destroy", "addItems", "removeItem", "renderItem", "renderItems", "setText", "setContent", "setHtml", "reload"]
        });
    }) (jQuery, Weiboyi);
    (function($, W, undefined) {
        ...
        W.confirm = function(msg, type, settings, callback) {
        ...
        W.alert = function(msg, type, settings, callback) {
            if (typeof type === "function") {
                callback = type;
                type = "info";
            }
